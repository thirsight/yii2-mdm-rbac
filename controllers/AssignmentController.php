...
use Yii;
use mdm\rbac\models\Assignment;
use mdm\rbac\models\searchs\Assignment as AssignmentSearch;
...
class AssignmentController extends Controller
{
    ...
    public function actionAssign($id, $action)
    {
        ...
        return [$this->actionRoleSearch($id, 'avaliable', (!isset($post['search_av']) ? '' : $post['search_av'])),
            $this->actionRoleSearch($id, 'assigned', (!isset($post['search_asgn']) ? '' : $post['search_asgn'])),
            $error];
    }
